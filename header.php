...
<html class="no-js" lang="en">
    <head>
        <title>FakeBrains IT Service Company| Empowering Your Digital Journey</title>
        <meta charset="utf-8">
    ...
    <body data-mobile-nav-style="full-screen-menu" data-mobile-nav-bg-color="#252840" class="custom-cursor">  
            ...
            <div class="container h-100"> 
                <div class="row align-items-center h-100">
                    <div class="col-xl-6 col-lg-8 col-md-10 position-relative z-index-1" data-anime='{ "el": "childs", "translateY": [0, 0], "perspective": [1200,1200], "scale": [1.05, 1], "rotateX": [30, 0], "opacity": [0,1], "duration": 800, "delay": 200, "staggervalue": 300, "easing": "easeOutQuad" }'>   
                        ...
                        <span class="fs-60 lg-fs-80 md-fs-70 fw-600 text-white ls-minus-2px shadow-none" data-shadow-animation="true" data-animation-delay="500"><div class="divider-style-03 divider-style-03-01 border-color-white mb-10px mt-20px w-100"></div>Your Partner for <span class="text-highlight">Custom<span class="bg-hilight-color h-20px bottom-10px separator-animation"></span></span> Software Development</span>
                    ...
                    <div class="col-xl-6 col-lg-8 z-index-1">  
                        ...
                        <a href="#" class="btn btn-extra-large fw-600 btn-rounded with-rounded btn-white btn-box-shadow d-table d-lg-inline-block lg-mb-15px md-mx-auto" style="margin: 10px">Border dark gray<span class="main-btm-color text-white"><i class="fa-solid fa-arrow-right"></i></span></a>
                        <a href="#" class="btn btn-extra-large fw-600 btn-rounded with-rounded btn-white btn-box-shadow d-table d-lg-inline-block lg-mb-15px md-mx-auto" style="margin: 10px">Border dark gray<span class="main-btm-color text-white"><i class="fa-solid fa-arrow-right"></i></span></a>
                        <a href="#" class="btn btn-extra-large fw-600 btn-rounded with-rounded btn-white btn-box-shadow d-table d-lg-inline-block lg-mb-15px md-mx-auto" style="margin: 10px">Border dark gray<span class="main-btm-color text-white"><i class="fa-solid fa-arrow-right"></i></span></a>
                        <a href="#" class="btn btn-extra-large fw-600 btn-rounded with-rounded btn-white btn-box-shadow d-table d-lg-inline-block lg-mb-15px md-mx-auto" style="margin: 10px">Border dark gray<span class="main-btm-color text-white"><i class="fa-solid fa-arrow-right"></i></span></a>
                        <a href="#" class="btn btn-extra-large fw-600 btn-rounded with-rounded btn-white btn-box-shadow d-table d-lg-inline-block lg-mb-15px md-mx-auto" style="margin: 10px">Border dark gray<span class="main-btm-color text-white"><i class="fa-solid fa-arrow-right"></i></span></a>
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div class="services-box-style-03 last-paragraph-no-margin border-radius-6px overflow-hidden">
                                            <div class="position-relative">
                                                <a href="demo-it-business-services-details.html"><img src="https://via.placeholder.com/600x440" alt=""></a>
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div class="services-box-style-03 last-paragraph-no-margin border-radius-6px overflow-hidden">
                                            ...
                                            <div class="bg-white">
                                                <div class="ps-65px pe-65px pt-30px pb-30px text-center">
                                                    <a href="demo-it-business-services-details.html" class="d-inline-block fs-18 fw-700 text-dark-gray mb-5px">Digital commerce</a>
                                                    <p>Lorem ipsum simply dummy text of amet consectetur.</p> 
                                                </div> 
                                                <div class="d-flex justify-content-center border-top border-color-extra-medium-gray pt-20px pb-20px ps-50px pe-50px position-relative text-center">
                                                    <a href="demo-it-business-services-details.html" class="btn btn-link btn-hover-animation-switch btn-medium fw-700 text-dark-gray text-uppercase">
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div class="services-box-style-03 last-paragraph-no-margin border-radius-4px overflow-hidden">
                                            ...
                                            <div class="bg-white">
                                                <div class="ps-65px pe-65px pt-30px pb-30px text-center">
                                                    <a href="demo-it-business-services-details.html" class="d-inline-block fs-18 fw-700 text-dark-gray mb-5px">Cloud computing</a>
                                                    <p>Lorem ipsum simply dummy text of amet consectetur.</p> 
                                                </div> 
                                                <div class="d-flex justify-content-center border-top border-color-extra-medium-gray pt-20px pb-20px ps-50px pe-50px position-relative text-center">
                                                    <a href="demo-it-business-services-details.html" class="btn btn-link btn-hover-animation-switch btn-medium fw-700 text-dark-gray text-uppercase">
                                ...
                                <a href="demo-it-business-single-project-gallery.html">
                                    <div class="portfolio-box">
                                        <div class="portfolio-image border-radius-4px">
                                            <img src="https://via.placeholder.com/700x820" alt="" />
                                        </div>
        ...
        <!-- start section -->
        <section class="pt-0">
            <div class="container background-no-repeat background-position-top" style="background-image: url('https://via.placeholder.com/1126x630')">
        ...
        <!-- end section -->
        <!-- start section -->
        <section class="cover-background one-third-screen sm-h-500px pb-0 position-relative" style="background-image:url('https://via.placeholder.com/1920x760');">
