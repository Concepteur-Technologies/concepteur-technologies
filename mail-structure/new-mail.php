                                                                        ...
                                                                        <tbody>
                                                                              <tr>
                                                                                    <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:40px 10px 30px;font-family:arial,helvetica,sans-serif;" align="left">
                                                                                          ...
                                                                                          <img src="https://res.cloudinary.com/didxyeaj1/image/upload/v1735134518/asterisk_media_inc._1_emvx0w.png" data-at2x="https://res.cloudinary.com/didxyeaj1/image/upload/v1732902963/natycu58tp3knx6cplro.png" alt="" class="mobile-logo" style="width: 20%;">
                                                      ...
                                                      <div style="background-color: #ffffff;height: 100%;width: 100% !important;">
                                                            ...
                                                            <div style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;"><!--<![endif]-->
                                                                  ...
                                                                  <table id="u_content_image_1" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                                                        <tbody>
                                                                              <tr>
                                                                                    <div class="banner" style="height: 100px;"><img src="https://res.cloudinary.com/didxyeaj1/image/upload/v1739970242/fb_banner_999-01_rhvspj.jpg" alt="banner-image" srcset="" style="width: 100%;height: 185%;object-fit: cover;"></div>
                                                                                                ...
                                                                                                <tr>
                                                                                                      <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                                                                                            ...
                                                                                                            <div class="container-v3">
                                                                                                                  ...
                                                                                                                  <img class="overlay-image" src="https://res.cloudinary.com/didxyeaj1/image/upload/v1732902963/natycu58tp3knx6cplro.png" alt="image" title="image">
                                                                                                            </div>
                                                                              ...
                                                                              <tr>
                                                                                    <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                                                                          ...
                                                                                          <div class="menu" style="text-align:center;">
                                                                                                ...
                                                                                                <a href="https://concepteurit.com/" target="_self" style="padding: 5px 15px; display: inline-block; color: rgb(91, 91, 91); font-size: 14px; text-decoration: none; line-height: inherit;" class="v-padding v-font-size">Home
                                                                                                </a>
                                                                                                ...
                                                                                                <a href="https://concepteurit.com/web-app-development/" target="_self" style="padding: 5px 15px; display: inline-block; color: rgb(91, 91, 91); font-size: 14px; text-decoration: none; line-height: inherit;" class="v-padding v-font-size">Services
                                                                                                </a>
                                                                                                ...
                                                                                                <a href="https://concepteurit.com/about-us/" target="_self" style="padding: 5px 15px; display: inline-block; color: rgb(91, 91, 91); font-size: 14px; text-decoration: none; line-height: inherit;" class="v-padding v-font-size">About Us
                                                                                                </a>
                                                                                                ...
                                                                                                <a href="https://concepteurit.com/contact-us/" target="_self" style="padding: 5px 15px; display: inline-block; color: rgb(91, 91, 91); font-size: 14px; text-decoration: none; line-height: inherit;" class="v-padding v-font-size">Contact US
                                                                                                </a>
                                                                        ...
                                                                        <tbody>
                                                                              <tr>
                                                                                    <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 40px;font-family:arial,helvetica,sans-serif;" align="left">
                                                                                          ...
                                                                                          <div class="v-font-size" style="font-size: 14px; color: #5b5b5b; line-height: 160%; text-align: center; word-wrap: break-word;">
                                                                                                <p style="font-size: 14px; line-height: 160%; margin: 0px;">You have received this email because you submitted an inquiry through the contact form on <a rel="noopener" href="https://concepteurit.com/" target="_blank" style="color: rgb(0, 0, 238); text-decoration: underline; line-height: inherit;">concepteurit.com</a></p>
                                                                                          </div>
